...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="md:grid grid-cols-3 bg-gray-100">
        ...
        <div class="bg-gray-100">
            <h1 class="text-4xl underline bold font-bold align-center text-center pt-5">RUMAH KITA 2</h1>
            <h3 class="text-xl align-center text-center mt-5 pb-4">Motel</h3>
            <div class="grid grid-cols-3 mb-5">
                <div class="m-auto">
                    <a href="https://www.google.com/maps/place/Kos+bebas+harian/@-7.9363897,112.6358246,17z/data=!3m1!4b1!4m5!3m4!1s0x2dd629f8c9076ddf:0x960005584b1fb9aa!8m2!3d-7.9363897!4d112.6380133">
    ...
    <section class="bg-white py-8">
      <div class="sm:grid grid-cols-4 gap-5 mx-4">
        <div class="container">
            <img src="assets/kasur2.jpeg">
            <div class="text-center py-4">Kasur tipe 160 + Lemari
            </div>
        </div>

        <div class="container">
            <img src="assets/tv2.jpeg">
            <div class="text-center py-4">Meja komputer + Kursi + Lemari</div>
        </div>

        <div class="container">
            <img src="assets/mandi2.jpeg">
            <div class="text-center py-4">Kamar Mandi Dalam + Air Panas</div>
        </div>
        
        <div class="container">
            <img src="assets/ac2.jpeg">
            <div class="text-center py-4">AC + TV </div>
        </div>
    ...
    <section class="bg-white py-8">
        <div class="sm:grid grid-cols-3 gap-5 mx-4">
          ...
          <div class="container">
              <img src="assets/ac2b.jpeg">
              <div class="text-center py-4">AC + TV + Meja Komputer</div>
          </div>
