...
<head>
    ...
    <title>rumahkita.com: kos 1</title>
...
<body class="bg-white text-gray-600 work-sans leading-normal text-base tracking-normal">
    ...
    <div class="md:grid grid-cols-3 bg-gray-100">
        <div ></div>
        <div >
            <h1 class="text-4xl underline bold font-bold align-center text-center pt-5">RUMAH KITA 1</h1>
            <h3 class="text-xl align-center text-center mt-5 pb-4">Motel</h3>\
            <div class="grid grid-cols-3 mb-5">
                <div class="m-auto">
                    <a href="https://www.google.com/maps/place/Penginapan+Murah+Borobudur/@-7.9362968,112.6319463,15z/data=!4m9!1m2!2m1!1sPenginapan+Murah+Borobudur!3m5!1s0x2dd629eb9d81f98d:0x951b1ee1bc4799eb!8m2!3d-7.9362968!4d112.640701!15sChpQZW5naW5hcGFuIE11cmFoIEJvcm9idWR1clocIhpwZW5naW5hcGFuIG11cmFoIGJvcm9idWR1cpIBBWhvdGVsmgEkQ2hkRFNVaE5NRzluUzBWSlEwRm5TVU5wTkdWMVduRjNSUkFC">
                        <button class="bg-red-600 hover:bg-red-700 py-5 px-10 text-white bold text-lg md:rounded-xl">
                ...
                <div class="m-auto">
                    <a href="https://business.google.com/initiateChat?args=ChcIAxITNDk3ODAyMTIxMzgwMDk0NjY0MhonSGFpLCBhZGEgeWFuZyBiaXNhIHNheWEgYmFudHUgaGFyaSBpbmk_Mj4KN3R5cGUuZ29vZ2xlYXBpcy5jb20vY2hhdC5ib3QucGxhdGZvcm0uQ3VzdG9tU2Vzc2lvbkRhdGESAwoBAlAEYgd3ZWJ2aWV3ajhodHRwOi8vcmJtLmdvb2cvcmJtbS1hdXRvcHVzaC9jb252ZXJzYXRpb25zL2NvbnZlcnNhdGlvbnIrCAMSEzQ5NzgwMjEyMTM4MDA5NDY2NDIaBGdtYmwiDDk2ODYxMDU1NDU0MKABzqm49vr_____AQ&hl=in&gl=ID&v=1&chtn=ACGVSk_U_o1t2uZFXO9phGlT_6g_gQ2wBQ">
                        <button class="bg-yellow-600 hover:bg-yellow-700 py-5 px-10 text-white bold text-lg md:rounded-xl">
                ...
                <div class="m-auto">
                    <a href="https://api.whatsapp.com/send?phone=+6282231874897">
                        <button class="bg-green-600 hover:bg-green-700 py-5 px-8 md:ml-3 text-white bold text-lg md:rounded-xl">
    ...
    <h1 class="text-2xl text-center py-8">Kamar Tipe A (Khusus Harian)</h1>
    <section class="bg-white py-8">
      <div class="sm:grid grid-cols-3 gap-5 mx-4">
        <div class="container">
            <img src="assets/kasur1.JPG">
            <div class="text-center py-4">Kasur tipe 160 + 120
            </div>
        </div>

        <div class="container">
            <img src="assets/meja1.JPG">
            <div class="text-center py-4">Meja kerja + AC</div>
        </div>

        <div class="container">
            <img src="assets/mandi1.JPG">
            <div class="text-center py-4">Kamar Mandi Dalam + Air Panas</div>
        </div>
    ...
    <h1 class="text-2xl text-center py-8">Kamar Tipe B (Harian & Bulanan)</h1>
    <section class="bg-white py-8">
        <div class="sm:grid grid-cols-3 gap-5 mx-4">
          <div class="container">
              <img src="assets/kasur1b.JPG">
              <div class="text-center py-4">2 Kasur tipe 120
              </div>
          </div>
  
          <div class="container">
              <img src="assets/mandi1b.JPG">
              <div class="text-center py-4">Kamar Mandi Dalam </div>
          </div>
          
          <div class="container">
              <img src="assets/perabot1b.JPG">
              <div class="text-center py-4">Kipas + Meja Komputer</div>
          </div>
      ...
      <h1 class="text-2xl text-center py-8">Kamar Tipe C (Harian & Bulanan)</h1>
    <section class="bg-white py-8">
        <div class="sm:grid grid-cols-3 gap-5 mx-4">
          <div class="container">
              <img src="assets/kasur1c.JPG">
              <div class="text-center py-4">2 Kasur tipe 120
              </div>
          </div>
  
          <div class="container">
              <img src="assets/mandi1c.JPG">
              <div class="text-center py-4">Kamar Mandi Dalam </div>
          </div>
          
          <div class="container">
              <img src="assets/tv1c.JPG">
              <div class="text-center py-4">Kipas + TV + Meja Komputer</div>
          </div>
      ...
      <h1 class="text-2xl text-center py-8">Fasilitas Lain</h1>
    <section class="bg-white py-8">
        <div class="sm:grid grid-cols-4 gap-5 mx-4">
          <div class="container">
              <img src="assets/resized.jpeg">
              <div class="text-center py-4">Parkir Luas
              </div>
          </div>
  
          <div class="container">
              <img src="assets/lt1.jpg">
              <div class="text-center py-4">Smoking Area lt-1</div>
          </div>
          
          <div class="container">
              <img src="assets/lt2.jpeg">
              <div class="text-center py-4">Smoking Area lt-2</div>
          </div>

          <div class="container">
            <img src="assets/dapur.jpeg ">
            <div class="text-center py-4">Dapur Bersama</div>
        </div>
